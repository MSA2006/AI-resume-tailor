...
export async function generatePDF(data, mode = "professional") {
  ...
  // Sanitize unicode chars that WinAnsi can't encode
  if (title) title = title.replace(/\u2011/g, "-").replace(/\u2013/g, "-").replace(/\u2014/g, "--").replace(/\u2018/g, "'").replace(/\u2019/g, "'").replace(/\u201c/g, '"').replace(/\u201d/g, '"').replace(/[^\x00-\xFF]/g, "");
  if (organization) organization = organization.replace(/\u2011/g, "-").replace(/\u2013/g, "-").replace(/\u2014/g, "--").replace(/\u2018/g, "'").replace(/\u2019/g, "'").replace(/\u201c/g, '"').replace(/\u201d/g, '"').replace(/[^\x00-\xFF]/g, "");
  if (date) date = date.replace(/\u2011/g, "-").replace(/\u2013/g, "-").replace(/\u2014/g, "--").replace(/[^\x00-\xFF]/g, "");
  checkSpace(20);
  y -= 5;
